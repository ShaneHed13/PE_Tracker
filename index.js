...
.get('/db-info', async(req, res) => {
    ...
    try{
        ...
        const tables = await client.query(
            ...
            `SELECT c.relname AS table, a.attname AS column, t.typname AS 
            type
...
.post('/log', async(req, res) => {
    try{        
        ...
        const studentsId = req.body.sutdents_id;
        const tasksId = req.body.tasks_Id;
        const duration = req.body.duration;

        
        const sqlInsert = await client.query(
        `INSERT INTO observations (users_id, sutdents_id, tasks_id, duration)
